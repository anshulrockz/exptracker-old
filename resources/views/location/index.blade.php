                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/locations/'.$list->id)}}" class="btn btn-sm btn-success"> View </a>
                                    <a href="{{ url('/locations/'.$list->id.'/edit')}}" class="btn btn-sm btn-info"> Edit </a>
