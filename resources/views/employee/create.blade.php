                ...
                <form method="post" action="{{route('employees.store')}}">
	                ...
	                <div class="row clearfix">
	                    ...
	                    <div class="col-sm-6">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <input type="text" id="dob" name="dob" class="form-control" placeholder="Enter dob" value="{{ old('dob') }}">
		                        </div>
		                    </div>
	                    </div>
	                    ...
	                    <div class="col-sm-12">
		                    ...
		                    <div class="form-group">
		                        <div class="form-line">
		                            <textarea id="address" name="address" rows="1" class="form-control no-resize auto-growth" placeholder="Enter address of person(press ENTER for more lines)">{{ old('address') }}</textarea>
		                        </div>
		                    </div>
	                    </div>
                    </div>
